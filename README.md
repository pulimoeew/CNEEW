# CNEEW
#免责声明（Disclaimer）
本项目为个人开发的非官方地震信息与预警辅助软件，与中国地震局及其下属单位无任何隶属、授权或合作关系。
本软件提供的地震信息、预警信息及相关功能仅供学习、研究与技术交流使用，不构成任何形式的官方预警、灾害通知或安全保障。
由于网络延迟、接口变更、系统故障、设备限制、第三方数据源异常等因素，本软件：
无法保证预警信息的准确性、完整性或实时性
无法保证用户一定能够及时收到地震预警
不保证在任何情况下均可正常运行
不应作为唯一的避险或生命安全依据
在发生地震或其他紧急情况时，请务必以官方发布的信息为准，并优先使用官方地震预警渠道，例如：
中国地震台网及各省级行政区的地震预警微信小程序 / App
手机系统级地震预警功能
使用本软件即代表您已理解并同意：开发者不对因软件故障、预警延迟、信息错误、服务中断或其他原因造成的任何直接或间接损失承担责任。
